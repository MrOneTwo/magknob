...
static void board_setup_i2c(void)
{
	...
	// TODO(michalc): verify GPIO pins: if both should be pushpull and the actual numbers.

	i2c_reset(I2C1);
	// Setup GPIO pins (output with min output speed).
	gpio_set_mode(GPIOB, GPIO_MODE_OUTPUT_2_MHZ, GPIO_CNF_OUTPUT_ALTFN_PUSHPULL, GPIO6 | GPIO7);
